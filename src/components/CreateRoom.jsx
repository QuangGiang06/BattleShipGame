...
function CreateRoom({ playerName, setPlayerName, onCreateRoom }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh]">
      <h1 className="text-4xl sm:text-6xl text-center font-black mb-10 sm:mb-12 text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-indigo-500 tracking-tighter drop-shadow-[0_0_15px_rgba(34,211,238,0.5)]">
        TẠO PHÒNG MỚI
      </h1>
